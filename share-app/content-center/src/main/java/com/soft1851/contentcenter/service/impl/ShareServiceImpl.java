...
public class ShareServiceImpl implements ShareService {
    ...
    public ShareDTO findById(Integer id) {
        ...
        log.info("控制台打印的responseDTO:"+this.userCenterFeignClient.findUserById(userId));
...
//                    .build());
    ...
    public Share exchange(ExchangeDTO exchangeDTO) {
        log.info("fhelkfjesklfjslfjljfsdfdsfsd");
    ...
    @Override
    public List<Share> contributions(Integer userId) {
        Example example = new Example(Share.class);
        Example.Criteria criteria = example.createCriteria();
